      ...
      {/* {isOpenModal && (
       ...
       <div className="bg-white p-8 rounded-2xl shadow-lg text-center relative">
        ...
        X
         ...
         <h3 className="text-black text-lg font-bold mb-4">Thank you for clicking</h3>
         <address className="text-black text-left">
           Contact: <br />
           Omar Faruk <br />
           Dhaka, Bangladesh.<br />
         ...
         <div className="mt-5">
           <p className="text-black">Download My Resume</p>
           <button
            //  onClick={handleDownloadResume}
             className="bg-[#915EFF] px-4 py-2 rounded my-2 hover:bg-blue-500 text-white text-sm transition"
           >
             Resume
           </button>
         </div>
