...
const Hero = () => {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = "Resume_of_OmarFaruk.pdf";
    link.click();
  };
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      {/* //hero section main two contain ...  */}
      <div
        className={`absolute inset-0 xl:top-[200px] top-[120px] max-w-7xl mx-auto ${styles.paddingX}  pointer-events-none h-fit flex flex-row items-start gap-5`}
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-5">
          <div>
            ...
            <button
              ...
              className="bg-[#915EFF] text-white pointer-events-auto rounded px-2 py-1 mt-2 hover:bg-white hover:text-black transition duration-200"
            >
              Hire Me
            </button>
          </div>
      ...
      {/* //animation button that can move next section .. ..  */}
